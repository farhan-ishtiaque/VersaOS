...
public class moderatorFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton4.setFont(new java.awt.Font("Arial Black", 0, 14)); // NOI18N
        jToggleButton4.setText("DATABASE");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Database.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        AdminSearchFrame asf = new AdminSearchFrame();
        asf.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ModeratorDatabaseFrame mdf = new ModeratorDatabaseFrame();
        mdf.setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        AdminEditFrame aef = new AdminEditFrame();
        aef.setVisible(true);
