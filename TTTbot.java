 ...
 * @author ishma
 */
public class TTTbot extends javax.swing.JFrame {
    ...
    private boolean checkWinLossPlayer1() {
        ...
        if ((array[0][0] == 1 && array[1][1] == 1 && array[2][2] == 1)) {        // Diagonal \
            decision = true;
        } else if ((array[0][2] == 1 && array[1][1] == 1 && array[2][0] == 1)) {   // Diagonal /
            decision = true;
        } else if ((array[0][0] == 1 && array[1][0] == 1 && array[2][0] == 1)) {   // Vertical left
            decision = true;
        } else if ((array[0][1] == 1 && array[1][1] == 1 && array[2][1] == 1)) {   // Vertical middle
            decision = true;
        } else if ((array[0][2] == 1 && array[1][2] == 1 && array[2][2] == 1)) {   // Vertical Right
            decision = true;
        } else if ((array[0][0] == 1 && array[0][1] == 1 && array[0][2] == 1)) {    // Horizontal Top
            decision = true;
        } else if ((array[1][0] == 1 && array[1][1] == 1 && array[1][2] == 1)) {     // Horizontal Middle
            decision = true;
        } else if ((array[2][0] == 1 && array[2][1] == 1 && array[2][2] == 1)) {     // Horizontal Down
            decision = true;
        }
        return decision;
    }
    ...
    private boolean checkWinLossPlayer2() {
        boolean decision = false;
        if ((array[0][0] == 2 && array[1][1] == 2 && array[2][2] == 2)) {        // Diagonal \
            decision = true;
        } else if ((array[0][2] == 2 && array[1][1] == 2 && array[2][0] == 2)) {   // Diagonal /
            decision = true;
        } else if ((array[0][0] == 2 && array[1][0] == 2 && array[2][0] == 2)) {   // Vertical left
            decision = true;
        } else if ((array[0][1] == 2 && array[1][1] == 2 && array[2][1] == 2)) {   // Vertical middle
            decision = true;
        } else if ((array[0][2] == 2 && array[1][2] == 2 && array[2][2] == 2)) {   // Vertical Right
            decision = true;
        } else if ((array[0][0] == 2 && array[0][1] == 2 && array[0][2] == 2)) {    // Horizontal Top
            decision = true;
        } else if ((array[1][0] == 2 && array[1][1] == 2 && array[1][2] == 2)) {     // Horizontal Middle
            decision = true;
        } else if ((array[2][0] == 2 && array[2][1] == 2 && array[2][2] == 2)) {     // Horizontal Down
            decision = true;
        }
        return decision;
    }
    ...
    private void showWinLossDraw() {
        if (checkWinLossPlayer1()) {
            JOptionPane.showMessageDialog(TTTbot.this, "You won the Game!");
            updateScore();
            matchWon = true;
            lblPlayerTurn.setText("You won the Game!");
        } else if (checkWinLossPlayer2()) {
            JOptionPane.showMessageDialog(TTTbot.this, "BOT won the Game!");
            updateScore();
            matchWon = true;
            lblPlayerTurn.setText("BOT won the Game!");
        } else if (checkDraw()) {
            JOptionPane.showMessageDialog(TTTbot.this, "This Match is a Draw!");
            updateScore();
            matchWon = true;
    ...
    private void ShowScore() {
        ...
        player1ScoreLabel.setText("Your Score : " + player1score);
        player2ScoreLabel.setText("BOT Score : " + player2score);
    }

    private boolean checkEmptyIndex() {
    ...
    private void botMove() {
        lblPlayerTurn.setText("BOT's Turn : 'O'");

        boolean check = checkEmptyIndex();
        if (check) {
            int a = -2;
            int b = -3;
            boolean bot = true;
        ...
        lblPlayerTurn.setText("Your Turn : 'X'");
    }
    ...
    private void lbl02MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl02MouseClicked
        if (!matchWon) {
            if (array[0][2] == 0) {
                ...
                JOptionPane.showMessageDialog(TTTbot.this, "You Can not change previously set move");
            }
        } else {
            JOptionPane.showMessageDialog(TTTbot.this, "The Match has already ended");
        }
